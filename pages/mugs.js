      ...
      <section className="text-gray-600 body-font min-h-screen">
        <div className="container px-5 py-24 mx-auto">
          <div className="flex flex-wrap -m-4 justify-center">
            {Object.keys(products).length === 0 && <p>Sorry all the    are Currently out of stock. New stock coming soon. Stay Tuned!</p>}
              ...
              return <Link key={products[item].id} href={`/product/${products[item].slug}`}>
                <div className="lg:w-1/4 md:w-1/2 p-4 w-full cursor-pointer">
                  ...
                  <div className="mt-4 text-center">
                    <Etext color="#808080" variant="h1">Mugs</Etext>
...
export async function getServerSideProps(context) {
  ...
  let products = await Product.find({ categary: "mugs" })
  let mugs = {}
